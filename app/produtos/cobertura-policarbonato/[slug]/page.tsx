  ...
  return (
    <>
      <ProductSchema
        ...
        price={produto.preco}
        url={`https://coberturapolicarbonato.com.br/produtos/cobertura-fixa/${slug}`}
      />
      <main className="min-h-screen py-12">
        ...
        <nav className="mb-8 text-sm">
          ...
          {' / '}
          <Link href="/produtos/cobertura-fixa" className="text-blue-600 hover:underline">Cobertura Fixa</Link>
          {' / '}
