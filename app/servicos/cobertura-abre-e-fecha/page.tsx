...
export const metadata: Metadata = {
  ...
  keywords: "cobertura abre e fecha preço, cobertura abre e fecha SP, cobertura retrátil automatizada, cobertura abre e fecha policarbonato, cobertura automática preço, zetaflex abre e fecha",
  alternates: {
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <section className="mb-12 bg-gradient-to-br from-gray-900 to-black text-white rounded-lg p-8 shadow-sm">
            <h2 className="text-3xl font-bold mb-6">
              Por que a Cobersystem Supera Zetaflex e Concorrentes?
            </h2>
